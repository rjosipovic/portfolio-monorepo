...
public enum ErrorCode {
    ...
    CONFLICT(HttpStatus.CONFLICT, "G004", "Conflict"),
    CHALLENGE_NOT_FOUND_FOR_SUBSCRIPTION(HttpStatus.NOT_FOUND, "G005", "Challenge not found or access denied for subscription.");
