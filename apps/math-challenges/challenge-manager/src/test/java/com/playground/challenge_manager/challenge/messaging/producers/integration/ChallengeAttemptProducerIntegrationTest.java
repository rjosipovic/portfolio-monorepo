...
@Import(ChallengeAttemptProducerIntegrationTest.RabbitTestConfig.class)
...
class ChallengeAttemptProducerIntegrationTest {
    ...
    void whenPublishCorrectAnswer_thenMessageIsConsumedByCorrectListener() throws InterruptedException {
        ...
        // when
        challengeAttemptProducer.publishChallengeSolvedMessage(event);
    ...
    static class RabbitTestConfig {
        ...
        @Bean
        public ChallengeRepository challengeAttemptRepository() {
            return mock(ChallengeRepository.class);
        }
    }
